# as LLM calls are io-bound, it allows the use await
import asyncio
import os
...
async def main():
    ...
    model_client = OpenAIChatCompletionClient(
        ...
        # it js the information about the capabilities, and feature model provide, specifying what task it can perform
        model_info={
            "vision": False,
    ...
    while True:
        ...
        try:
            ...
            # in this line , res_task, provides us the resukt object, which have source, metadata, and extra info, along with response text
            # chat_message removes that extra segment(metadata, timing, ids, etc), and content give us the raw text, we want
            ...
            if not research_buffer.strip(): 
                print(" Research query fails."); continue # HERE ; is the python statement separator, used for small but related statement to be put together in a line
