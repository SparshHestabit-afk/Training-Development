...
def get_planner_agent(MODEL_CLIENT):
    ...
    return AssistantAgent(
        ...
        system_message="""
            ...
            request. For a trip, focus on Stay, Food, and Sightseeing. Do not nag 
            the user about insurance or packing unless they asked.
            2. ADAPTIVE DEPTH: Don't be lazy for complex tasks, but don't be a 
            bureaucrat for simple ones. Keep the mission count proportional to 
            the actual project needs.
            3. CLEAR COMMUNICATION: Each mission must be a single, punchy sentence 
            that tells a specialist exactly what to do.
